  ...
  module Builder
    ...
    class SitemapFile
      ...
      def file_can_fit?(bytes)
        ...
        (@filesize + bytes) < SitemapGenerator::MAX_SITEMAP_FILESIZE && @link_count < SitemapGenerator::Sitemap.max_sitemap_links && @news_count < SitemapGenerator::MAX_SITEMAP_NEWS
      end
